...
const navbar = () => {
  ...
  const [isNavVisible, setIsNavVisible] = useState(getInitialVisibility);
  ...
  useEffect(() => {
    const handleResize = () => {
      setIsNavVisible(window.innerWidth <= 640 ? false : true);
    };
  ...
  return (
    <header>
      <div className="navbar">
        ...
        <button className={`ham-btn ${window.innerWidth > 640 ? 'hidden' : ''}`}
